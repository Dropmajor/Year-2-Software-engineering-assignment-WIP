<?php
//this file is reused from my (s5406054 James Brown) web programming assignment, it was created with consideration of both this and the
...
class database
{
    ...
    //enter a query to bind params to and the data to bind, this function sanitises the data
